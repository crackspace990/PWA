    ...
    data.matches.forEach(match => {
      ...
      html += `
            <div class="card">
              ...
              <div class="col s12">Schedule: ${match.utcDate}</div>
                <div class="col s10">${match.homeTeam.name}</div>
                <div class="col s2">Score:${match.score.fullTime.homeTeam}</div>
                <h2>VS</h2>
                <div class="col s10">${match.awayTeam.name}</div>
                <div class="col s2">Score:${match.score.fullTime.awayTeam}</div>
              </div>
